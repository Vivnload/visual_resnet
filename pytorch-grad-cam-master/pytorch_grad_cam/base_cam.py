...
def loss_fn(preds,text_for_loss):
...
class BaseCAM:
    ...
    def get_loss(self, output, target_category,loss_fn):
        loss=loss_fn(output, target_category)
        # loss = 0
    ...
    def forward(self, input_tensor,target_category=None, eigen_smooth=False):
        ...
        loss = self.get_loss(output, target_category,loss_fn)
